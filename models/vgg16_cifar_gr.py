...
VGG_16 = [64, 64, "M1", 128, 128, "M1", 256, 512, 256, "M1", 512, 1024, 512, "M", 512, 1024, 512, "M"]
    ...
    def create_conv_layers(self, architecture):
        ...
        for x in architecture:
            ...
            if type(x) == int:
                ...
                if times==8 or times==12 or times==16:
                    layers += [
                        nn.Conv2d(
                            ...
                            stride=(1,1),
                            padding=(1,1),
                            groups=int(in_channels/4) ## group is the key point of the trick
                        ),
                        nn.BatchNorm2d(x),
                        nn.ReLU()
                    ]
                ...
                layers += [nn.MaxPool2d(kernel_size=(2,2), stride=(1,1),ceil_mode=True)]
            elif x=='M':
