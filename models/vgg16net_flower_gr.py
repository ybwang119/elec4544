...
VGG_16 = [64, 64, "M", 128, 128, "M", 256, 512, 256, "M", 512, 1024, 512, "M", 512, 1024, 512, "M"]
VGG_19 = [64, 64, "M", 128, 128, "M", 256, 256, 256, 256, "M", 512, 512, 512, 512, "M", 512, 512, 512, 512, "M"]

class VGG_net(nn.Module):
    def __init__(self, architecture, in_channels=3, num_classes=17):
...
class vgg16_flowers_gr(VGG_net):
    def __init__(self):
