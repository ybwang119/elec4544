...
class Alexnet_cifar_gr_compare(nn.Module):
    def __init__(self,classes: int):
        super().__init__()
        self.conv1=nn.Conv2d(in_channels=3,out_channels=128,kernel_size=11,stride=1,padding=2)
        ...
        self.conv4=nn.Conv2d(in_channels=512,out_channels=512,padding=1,stride=1,kernel_size=3)
